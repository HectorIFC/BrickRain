...
- Lock delay (500 ms, reset-capped), soft/hard drop, DAS auto-shift, scoring with combo and back-to-back bonuses, leveling and level-based well themes.
- **Leaderboard** persisted in the Roku registry: one best entry per nickname, ranked by score, surviving reboots.
- All 13 sound effects and all channel artwork are **original**, generated by the scripts in `tools/`.
